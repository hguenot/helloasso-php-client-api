...
class TagsApi
{
     ...
     * @return \fr\helloasso\v5\model\TagsInternalTagModel
     */
    public function getTag($tag_name, $with_count = 'false', $with_amount = 'false', $authorization = null)
    {
        list($response) = $this->getTagWithHttpInfo($tag_name, $with_count, $with_amount, $authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\TagsInternalTagModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagWithHttpInfo($tag_name, $with_count = 'false', $with_amount = 'false', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\TagsInternalTagModel';
        $request = $this->getTagRequest($tag_name, $with_count, $with_amount, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\TagsInternalTagModel',
     ...
     */
    public function getTagAsync($tag_name, $with_count = 'false', $with_amount = 'false', $authorization = null)
    {
        return $this->getTagAsyncWithHttpInfo($tag_name, $with_count, $with_amount, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagAsyncWithHttpInfo($tag_name, $with_count = 'false', $with_amount = 'false', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\TagsInternalTagModel';
        $request = $this->getTagRequest($tag_name, $with_count, $with_amount, $authorization);
     ...
     */
    protected function getTagRequest($tag_name, $with_count = 'false', $with_amount = 'false', $authorization = null)
    {
        // verify the required parameter 'tag_name' is set
        if ($tag_name === null || (is_array($tag_name) && count($tag_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tag_name when calling getTag'
            );
        }
        ...
        // query params
        if ($with_count !== null) {
            $queryParams['withCount'] = ObjectSerializer::toQueryValue($with_count);
        }
        // query params
        if ($with_amount !== null) {
            $queryParams['withAmount'] = ObjectSerializer::toQueryValue($with_amount);
        }
        // header params
