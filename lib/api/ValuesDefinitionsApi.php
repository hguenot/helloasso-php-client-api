...
class ValuesDefinitionsApi
{
     ...
     * @return \fr\helloasso\v5\model\AccountOrganismCategoryModel[]
     */
    public function getCategories($authorization = null)
    {
        list($response) = $this->getCategoriesWithHttpInfo($authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\AccountOrganismCategoryModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoriesWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\AccountOrganismCategoryModel[]';
        $request = $this->getCategoriesRequest($authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\AccountOrganismCategoryModel[]',
     ...
     */
    public function getCategoriesAsync($authorization = null)
    {
        return $this->getCategoriesAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoriesAsyncWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\AccountOrganismCategoryModel[]';
        $request = $this->getCategoriesRequest($authorization);
     ...
     */
    protected function getCategoriesRequest($authorization = null)
    {
    ...
    /**
     * Operation getCompanyLegalStatus
     *
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\AccountCompanyLegalStatusModel[]
     */
    public function getCompanyLegalStatus($authorization = null)
    {
        list($response) = $this->getCompanyLegalStatusWithHttpInfo($authorization);
        return $response;
    }

    /**
     * Operation getCompanyLegalStatusWithHttpInfo
     *
     * Get company legal status list
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\AccountCompanyLegalStatusModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompanyLegalStatusWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\AccountCompanyLegalStatusModel[]';
        $request = $this->getCompanyLegalStatusRequest($authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\AccountCompanyLegalStatusModel[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getCompanyLegalStatusAsync
     *
     * Get company legal status list
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCompanyLegalStatusAsync($authorization = null)
    {
        return $this->getCompanyLegalStatusAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCompanyLegalStatusAsyncWithHttpInfo
     *
     * Get company legal status list
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCompanyLegalStatusAsyncWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\AccountCompanyLegalStatusModel[]';
        $request = $this->getCompanyLegalStatusRequest($authorization);
    ...
    /**
     * Create request for operation 'getCompanyLegalStatus'
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCompanyLegalStatusRequest($authorization = null)
    {
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\TagsPublicTagModel[]
     */
    public function getPublicTags($authorization = null)
    {
        list($response) = $this->getPublicTagsWithHttpInfo($authorization);
        return $response;
    }

    /**
     * Operation getPublicTagsWithHttpInfo
     *
     * Get list of public tags
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\TagsPublicTagModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPublicTagsWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\TagsPublicTagModel[]';
        $request = $this->getPublicTagsRequest($authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\TagsPublicTagModel[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPublicTagsAsync($authorization = null)
    {
        return $this->getPublicTagsAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPublicTagsAsyncWithHttpInfo
     *
     * Get list of public tags
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPublicTagsAsyncWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\TagsPublicTagModel[]';
        $request = $this->getPublicTagsRequest($authorization);
    ...
    /**
     * Create request for operation 'getPublicTags'
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPublicTagsRequest($authorization = null)
    {
