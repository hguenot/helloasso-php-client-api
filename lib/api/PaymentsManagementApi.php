...
/**
 * PaymentsManagementApi Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
...
class PaymentsManagementApi
{
     ...
     * @param  object[] $states Filter results by states of payments (optional)
     * @param  string $sort_order Sort payments by ascending or descending order. Default is descending (optional, default to Desc)
     * @param  string $sort_field Sort payments by a specific field (Date or UpdateDate). Default is date (optional, default to Date)
     ...
     * @return \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment
     */
    public function getFormPayments($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        list($response) = $this->getFormPaymentsWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization);
        return $response;
    }

    /**
     * Operation getFormPaymentsWithHttpInfo
     *
     * Get information about payments made in a specific form
     *
     * @param  string $organization_slug The organization slug (required)
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFormPaymentsWithHttpInfo($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment';
        $request = $this->getFormPaymentsRequest($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment',
    ...
    /**
     * Operation getFormPaymentsAsync
     *
     * Get information about payments made in a specific form
     *
     * @param  string $organization_slug The organization slug (required)
     ...
     */
    public function getFormPaymentsAsync($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        return $this->getFormPaymentsAsyncWithHttpInfo($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFormPaymentsAsyncWithHttpInfo
     *
     * Get information about payments made in a specific form
     *
     * @param  string $organization_slug The organization slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFormPaymentsAsyncWithHttpInfo($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment';
        $request = $this->getFormPaymentsRequest($organization_slug, $form_slug, $form_type, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization);
    ...
    /**
     * Create request for operation 'getFormPayments'
     *
     * @param  string $organization_slug The organization slug (required)
     * @param  string $form_slug The form slug (required)
     * @param  string $form_type The form type CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop (required)
     ...
     */
    protected function getFormPaymentsRequest($organization_slug, $form_slug, $form_type, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        ...
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling getFormPayments'
            );
        }
        // verify the required parameter 'form_slug' is set
        if ($form_slug === null || (is_array($form_slug) && count($form_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $form_slug when calling getFormPayments'
            );
        }
        // verify the required parameter 'form_type' is set
        if ($form_type === null || (is_array($form_type) && count($form_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $form_type when calling getFormPayments'
            );
        }
    ...
    /**
     * Operation getOrganizationPayments
     *
     ...
     * @param  int $page_size The number of items per page (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  object[] $states The payment states (optional)
     * @param  string $sort_order Sort payments by ascending or descending order. Default is descending (optional, default to Desc)
     * @param  string $sort_field Sort payments by a specific field (Date or UpdateDate). Default is date (optional, default to Date)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     ...
     * @return \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment
     */
    public function getOrganizationPayments($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        list($response) = $this->getOrganizationPaymentsWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization);
        return $response;
    }

    /**
     * Operation getOrganizationPaymentsWithHttpInfo
     *
     * Get information about payments made to a specific organization
     *
     * @param  string $organization_slug The organization Slug (required)
     ...
     * @return array of \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationPaymentsWithHttpInfo($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment';
        $request = $this->getOrganizationPaymentsRequest($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization);
    ...
    /**
     * Operation getOrganizationPaymentsAsync
     *
     * Get information about payments made to a specific organization
     *
     * @param  string $organization_slug The organization Slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationPaymentsAsync($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        return $this->getOrganizationPaymentsAsyncWithHttpInfo($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrganizationPaymentsAsyncWithHttpInfo
     *
     * Get information about payments made to a specific organization
     *
     * @param  string $organization_slug The organization Slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationPaymentsAsyncWithHttpInfo($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfStatisticsPayment';
        $request = $this->getOrganizationPaymentsRequest($organization_slug, $from, $to, $user_search_key, $page_index, $page_size, $continuation_token, $states, $sort_order, $sort_field, $authorization);
    ...
    /**
     * Create request for operation 'getOrganizationPayments'
     *
     * @param  string $organization_slug The organization Slug (required)
     * @param  \DateTime $from First Date Filter (optional)
     * @param  \DateTime $to End Date Filter (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrganizationPaymentsRequest($organization_slug, $from = null, $to = null, $user_search_key = null, $page_index = '1', $page_size = '20', $continuation_token = null, $states = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        // verify the required parameter 'organization_slug' is set
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling getOrganizationPayments'
            );
        }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\StatisticsPaymentDetail
     */
    public function getPayment($payment_id, $authorization = null)
    {
        list($response) = $this->getPaymentWithHttpInfo($payment_id, $authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\StatisticsPaymentDetail, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentWithHttpInfo($payment_id, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\StatisticsPaymentDetail';
        $request = $this->getPaymentRequest($payment_id, $authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\StatisticsPaymentDetail',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentAsync($payment_id, $authorization = null)
    {
        return $this->getPaymentAsyncWithHttpInfo($payment_id, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentAsyncWithHttpInfo($payment_id, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\StatisticsPaymentDetail';
        $request = $this->getPaymentRequest($payment_id, $authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentRequest($payment_id, $authorization = null)
    {
     ...
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  object[] $form_types The form type CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop (optional)
     * @param  string $form_type The form type CrowdFunding, Membership, Event, Donation, PaymentForm, Checkout, Shop. This parameter must be used with the parameter {formId}. (optional)
     * @param  object[] $states Filter results by states of payments (optional)
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfPaymentPublicPaymentModel
     */
    public function getPayments($organization_slug, $from = null, $to = null, $page_size = '20', $continuation_token = null, $form_types = null, $form_type = null, $states = null, $user_id = null, $search_key = null, $amount = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        list($response) = $this->getPaymentsWithHttpInfo($organization_slug, $from, $to, $page_size, $continuation_token, $form_types, $form_type, $states, $user_id, $search_key, $amount, $sort_order, $sort_field, $authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfPaymentPublicPaymentModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsWithHttpInfo($organization_slug, $from = null, $to = null, $page_size = '20', $continuation_token = null, $form_types = null, $form_type = null, $states = null, $user_id = null, $search_key = null, $amount = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfPaymentPublicPaymentModel';
        $request = $this->getPaymentsRequest($organization_slug, $from, $to, $page_size, $continuation_token, $form_types, $form_type, $states, $user_id, $search_key, $amount, $sort_order, $sort_field, $authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfPaymentPublicPaymentModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentsAsync($organization_slug, $from = null, $to = null, $page_size = '20', $continuation_token = null, $form_types = null, $form_type = null, $states = null, $user_id = null, $search_key = null, $amount = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        return $this->getPaymentsAsyncWithHttpInfo($organization_slug, $from, $to, $page_size, $continuation_token, $form_types, $form_type, $states, $user_id, $search_key, $amount, $sort_order, $sort_field, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentsAsyncWithHttpInfo($organization_slug, $from = null, $to = null, $page_size = '20', $continuation_token = null, $form_types = null, $form_type = null, $states = null, $user_id = null, $search_key = null, $amount = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfPaymentPublicPaymentModel';
        $request = $this->getPaymentsRequest($organization_slug, $from, $to, $page_size, $continuation_token, $form_types, $form_type, $states, $user_id, $search_key, $amount, $sort_order, $sort_field, $authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentsRequest($organization_slug, $from = null, $to = null, $page_size = '20', $continuation_token = null, $form_types = null, $form_type = null, $states = null, $user_id = null, $search_key = null, $amount = null, $sort_order = 'Desc', $sort_field = 'Date', $authorization = null)
    {
        // verify the required parameter 'organization_slug' is set
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling getPayments'
            );
        }
        ...
        // query params
        if ($form_type !== null) {
            $queryParams['formType'] = ObjectSerializer::toQueryValue($form_type);
        }
        // query params
        if (is_array($states)) {
            $queryParams['states'] = $states;
        ...
        // query params
        if ($search_key !== null) {
            $queryParams['searchKey'] = ObjectSerializer::toQueryValue($search_key);
        }
        // query params
        if ($amount !== null) {
     ...
     * @return object
     */
    public function refundPayment($payment_id, $comment = null, $cancel_order = 'false', $send_refund_mail = 'true', $amount = '0', $authorization = null)
    {
        list($response) = $this->refundPaymentWithHttpInfo($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $authorization);
        return $response;
    }
     ...
     */
    public function refundPaymentWithHttpInfo($payment_id, $comment = null, $cancel_order = 'false', $send_refund_mail = 'true', $amount = '0', $authorization = null)
    {
        $returnType = 'object';
        $request = $this->refundPaymentRequest($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $authorization);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundPaymentAsync($payment_id, $comment = null, $cancel_order = 'false', $send_refund_mail = 'true', $amount = '0', $authorization = null)
    {
        return $this->refundPaymentAsyncWithHttpInfo($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundPaymentAsyncWithHttpInfo($payment_id, $comment = null, $cancel_order = 'false', $send_refund_mail = 'true', $amount = '0', $authorization = null)
    {
        $returnType = 'object';
        $request = $this->refundPaymentRequest($payment_id, $comment, $cancel_order, $send_refund_mail, $amount, $authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function refundPaymentRequest($payment_id, $comment = null, $cancel_order = 'false', $send_refund_mail = 'true', $amount = '0', $authorization = null)
    {
        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($cancel_order !== null) {
            $queryParams['cancelOrder'] = ObjectSerializer::toQueryValue($cancel_order);
        }
        // query params
        if ($send_refund_mail !== null) {
            $queryParams['sendRefundMail'] = ObjectSerializer::toQueryValue($send_refund_mail);
        }
        // query params
        if ($amount !== null) {
            $queryParams['amount'] = ObjectSerializer::toQueryValue($amount);
