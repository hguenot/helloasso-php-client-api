...
class DirectoryApi
{
    ...
    /**
     * Operation postFormsListRequest
     *
     * Get all forms by form filters and organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListFormsRequest $body Body which contains the filters to apply (required)
     ...
     * @return \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel
     */
    public function postFormsListRequest($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        list($response) = $this->postFormsListRequestWithHttpInfo($body, $page_size, $continuation_token, $authorization);
        return $response;
    }

    /**
     * Operation postFormsListRequestWithHttpInfo
     *
     * Get all forms by form filters and organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListFormsRequest $body Body which contains the filters to apply (required)
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFormsListRequestWithHttpInfo($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel';
        $request = $this->postFormsListRequestRequest($body, $page_size, $continuation_token, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel',
    ...
    /**
     * Operation postFormsListRequestAsync
     *
     * Get all forms by form filters and organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListFormsRequest $body Body which contains the filters to apply (required)
     ...
     */
    public function postFormsListRequestAsync($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        return $this->postFormsListRequestAsyncWithHttpInfo($body, $page_size, $continuation_token, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postFormsListRequestAsyncWithHttpInfo
     *
     * Get all forms by form filters and organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListFormsRequest $body Body which contains the filters to apply (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFormsListRequestAsyncWithHttpInfo($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel';
        $request = $this->postFormsListRequestRequest($body, $page_size, $continuation_token, $authorization);
    ...
    /**
     * Create request for operation 'postFormsListRequest'
     *
     * @param  \fr\helloasso\v5\model\DirectoryListFormsRequest $body Body which contains the filters to apply (required)
     * @param  int $page_size The number of items per page (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     ...
     */
    protected function postFormsListRequestRequest($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postFormsListRequest'
            );
        }
    ...
    /**
     * Operation postOrganizationsListRequest
     *
     * Get all organization by organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListOrganizationsRequest $body Body which contains the filters to apply (required)
     * @param  int $page_size The number of items per page (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel
     */
    public function postOrganizationsListRequest($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        list($response) = $this->postOrganizationsListRequestWithHttpInfo($body, $page_size, $continuation_token, $authorization);
        return $response;
    }

    /**
     * Operation postOrganizationsListRequestWithHttpInfo
     *
     * Get all organization by organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListOrganizationsRequest $body Body which contains the filters to apply (required)
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function postOrganizationsListRequestWithHttpInfo($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel';
        $request = $this->postOrganizationsListRequestRequest($body, $page_size, $continuation_token, $authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postOrganizationsListRequestAsync
     *
     * Get all organization by organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListOrganizationsRequest $body Body which contains the filters to apply (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postOrganizationsListRequestAsync($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        return $this->postOrganizationsListRequestAsyncWithHttpInfo($body, $page_size, $continuation_token, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postOrganizationsListRequestAsyncWithHttpInfo
     *
     * Get all organization by organization filters
     *
     * @param  \fr\helloasso\v5\model\DirectoryListOrganizationsRequest $body Body which contains the filters to apply (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postOrganizationsListRequestAsyncWithHttpInfo($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel';
        $request = $this->postOrganizationsListRequestRequest($body, $page_size, $continuation_token, $authorization);
    ...
    /**
     * Create request for operation 'postOrganizationsListRequest'
     *
     * @param  \fr\helloasso\v5\model\DirectoryListOrganizationsRequest $body Body which contains the filters to apply (required)
     * @param  int $page_size The number of items per page (optional, default to 20)
     * @param  string $continuation_token Continuation Token from which we wish to retrieve results (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postOrganizationsListRequestRequest($body, $page_size = '20', $continuation_token = null, $authorization = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postOrganizationsListRequest'
            );
        }
