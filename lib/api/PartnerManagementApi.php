...
/**
 * PartnerManagementApi Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
...
class PartnerManagementApi
{
    ...
    /**
     * Operation deletePartnerOrganizationUrlNotification
     *
     ...
     * @return void
     */
    public function deletePartnerOrganizationUrlNotification($organization_slug, $authorization = null)
    {
        $this->deletePartnerOrganizationUrlNotificationWithHttpInfo($organization_slug, $authorization);
    }

    /**
     * Operation deletePartnerOrganizationUrlNotificationWithHttpInfo
     *
     * A partner can delete a notification url linked to an organization
     *
     ...
     */
    public function deletePartnerOrganizationUrlNotificationWithHttpInfo($organization_slug, $authorization = null)
    {
        $returnType = '';
        $request = $this->deletePartnerOrganizationUrlNotificationRequest($organization_slug, $authorization);
    ...
    /**
     * Operation deletePartnerOrganizationUrlNotificationAsync
     *
     * A partner can delete a notification url linked to an organization
     *
     * @param  string $organization_slug (required)
     ...
     */
    public function deletePartnerOrganizationUrlNotificationAsync($organization_slug, $authorization = null)
    {
        return $this->deletePartnerOrganizationUrlNotificationAsyncWithHttpInfo($organization_slug, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deletePartnerOrganizationUrlNotificationAsyncWithHttpInfo
     *
     * A partner can delete a notification url linked to an organization
     *
     * @param  string $organization_slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePartnerOrganizationUrlNotificationAsyncWithHttpInfo($organization_slug, $authorization = null)
    {
        $returnType = '';
        $request = $this->deletePartnerOrganizationUrlNotificationRequest($organization_slug, $authorization);
    ...
    /**
     * Create request for operation 'deletePartnerOrganizationUrlNotification'
     *
     * @param  string $organization_slug (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     ...
     */
    protected function deletePartnerOrganizationUrlNotificationRequest($organization_slug, $authorization = null)
    {
        ...
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling deletePartnerOrganizationUrlNotification'
            );
        }
    ...
    /**
     * Operation deletePartnerUrlNotification
     *
     ...
     * @return void
     */
    public function deletePartnerUrlNotification($authorization = null)
    {
        $this->deletePartnerUrlNotificationWithHttpInfo($authorization);
    }

    /**
     * Operation deletePartnerUrlNotificationWithHttpInfo
     *
     * A partner can delete his main notification url
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deletePartnerUrlNotificationWithHttpInfo($authorization = null)
    {
        $returnType = '';
        $request = $this->deletePartnerUrlNotificationRequest($authorization);
    ...
    /**
     * Operation deletePartnerUrlNotificationAsync
     *
     * A partner can delete his main notification url
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePartnerUrlNotificationAsync($authorization = null)
    {
        return $this->deletePartnerUrlNotificationAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deletePartnerUrlNotificationAsyncWithHttpInfo
     *
     * A partner can delete his main notification url
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePartnerUrlNotificationAsyncWithHttpInfo($authorization = null)
    {
        $returnType = '';
        $request = $this->deletePartnerUrlNotificationRequest($authorization);
    ...
    /**
     * Create request for operation 'deletePartnerUrlNotification'
     *
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deletePartnerUrlNotificationRequest($authorization = null)
    {
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel
     */
    public function getOrganizations($page_size = '20', $continuation_token = null, $authorization = null)
    {
        list($response) = $this->getOrganizationsWithHttpInfo($page_size, $continuation_token, $authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationsWithHttpInfo($page_size = '20', $continuation_token = null, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel';
        $request = $this->getOrganizationsRequest($page_size, $continuation_token, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationsAsync($page_size = '20', $continuation_token = null, $authorization = null)
    {
        return $this->getOrganizationsAsyncWithHttpInfo($page_size, $continuation_token, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationsAsyncWithHttpInfo($page_size = '20', $continuation_token = null, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel';
        $request = $this->getOrganizationsRequest($page_size, $continuation_token, $authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrganizationsRequest($page_size = '20', $continuation_token = null, $authorization = null)
    {
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\PartnersPartnerPublicModel
     */
    public function getPartner($authorization = null)
    {
        list($response) = $this->getPartnerWithHttpInfo($authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\PartnersPartnerPublicModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\PartnersPartnerPublicModel';
        $request = $this->getPartnerRequest($authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\PartnersPartnerPublicModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerAsync($authorization = null)
    {
        return $this->getPartnerAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerAsyncWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\PartnersPartnerPublicModel';
        $request = $this->getPartnerRequest($authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerRequest($authorization = null)
    {
    ...
    /**
     * Operation putPartnerDomain
     *
     * A partner can update his domain
     *
     * @param  \fr\helloasso\v5\model\AccountsClientsPublicPutApiClientRequest $body body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function putPartnerDomain($body, $authorization = null)
    {
        $this->putPartnerDomainWithHttpInfo($body, $authorization);
    }

    /**
     * Operation putPartnerDomainWithHttpInfo
     *
     * A partner can update his domain
     *
     * @param  \fr\helloasso\v5\model\AccountsClientsPublicPutApiClientRequest $body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putPartnerDomainWithHttpInfo($body, $authorization = null)
    {
        $returnType = '';
        $request = $this->putPartnerDomainRequest($body, $authorization);
    ...
    /**
     * Operation putPartnerDomainAsync
     *
     * A partner can update his domain
     *
     * @param  \fr\helloasso\v5\model\AccountsClientsPublicPutApiClientRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPartnerDomainAsync($body, $authorization = null)
    {
        return $this->putPartnerDomainAsyncWithHttpInfo($body, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putPartnerDomainAsyncWithHttpInfo
     *
     * A partner can update his domain
     *
     * @param  \fr\helloasso\v5\model\AccountsClientsPublicPutApiClientRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPartnerDomainAsyncWithHttpInfo($body, $authorization = null)
    {
        $returnType = '';
        $request = $this->putPartnerDomainRequest($body, $authorization);
    ...
    /**
     * Create request for operation 'putPartnerDomain'
     *
     * @param  \fr\helloasso\v5\model\AccountsClientsPublicPutApiClientRequest $body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putPartnerDomainRequest($body, $authorization = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putPartnerDomain'
            );
        }
    ...
    /**
     * Operation putPartnerOrganizationUrlNotification
     *
     * A partner can update a notification url linked to an organization
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body body (required)
     * @param  string $organization_slug organization_slug (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     ...
     * @return void
     */
    public function putPartnerOrganizationUrlNotification($body, $organization_slug, $authorization = null)
    {
        $this->putPartnerOrganizationUrlNotificationWithHttpInfo($body, $organization_slug, $authorization);
    }

    /**
     * Operation putPartnerOrganizationUrlNotificationWithHttpInfo
     *
     * A partner can update a notification url linked to an organization
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     * @param  string $organization_slug (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putPartnerOrganizationUrlNotificationWithHttpInfo($body, $organization_slug, $authorization = null)
    {
        $returnType = '';
        $request = $this->putPartnerOrganizationUrlNotificationRequest($body, $organization_slug, $authorization);
    ...
    /**
     * Operation putPartnerOrganizationUrlNotificationAsync
     *
     * A partner can update a notification url linked to an organization
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPartnerOrganizationUrlNotificationAsync($body, $organization_slug, $authorization = null)
    {
        return $this->putPartnerOrganizationUrlNotificationAsyncWithHttpInfo($body, $organization_slug, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putPartnerOrganizationUrlNotificationAsyncWithHttpInfo
     *
     * A partner can update a notification url linked to an organization
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPartnerOrganizationUrlNotificationAsyncWithHttpInfo($body, $organization_slug, $authorization = null)
    {
        $returnType = '';
        $request = $this->putPartnerOrganizationUrlNotificationRequest($body, $organization_slug, $authorization);
    ...
    /**
     * Create request for operation 'putPartnerOrganizationUrlNotification'
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     * @param  string $organization_slug (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putPartnerOrganizationUrlNotificationRequest($body, $organization_slug, $authorization = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putPartnerOrganizationUrlNotification'
            );
        }
        // verify the required parameter 'organization_slug' is set
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling putPartnerOrganizationUrlNotification'
            );
        }
    ...
    /**
     * Operation putPartnerUrlNotification
     *
     ...
     * @return void
     */
    public function putPartnerUrlNotification($body, $authorization = null)
    {
        $this->putPartnerUrlNotificationWithHttpInfo($body, $authorization);
    }

    /**
     * Operation putPartnerUrlNotificationWithHttpInfo
     *
     * A partner can update his main notification url
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putPartnerUrlNotificationWithHttpInfo($body, $authorization = null)
    {
        $returnType = '';
        $request = $this->putPartnerUrlNotificationRequest($body, $authorization);
    ...
    /**
     * Operation putPartnerUrlNotificationAsync
     *
     * A partner can update his main notification url
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPartnerUrlNotificationAsync($body, $authorization = null)
    {
        return $this->putPartnerUrlNotificationAsyncWithHttpInfo($body, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putPartnerUrlNotificationAsyncWithHttpInfo
     *
     * A partner can update his main notification url
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPartnerUrlNotificationAsyncWithHttpInfo($body, $authorization = null)
    {
        $returnType = '';
        $request = $this->putPartnerUrlNotificationRequest($body, $authorization);
    ...
    /**
     * Create request for operation 'putPartnerUrlNotification'
     *
     * @param  \fr\helloasso\v5\model\ApiNotificationsPostApiUrlNotificationBody $body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putPartnerUrlNotificationRequest($body, $authorization = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putPartnerUrlNotification'
            );
        }
