...
/**
 * OrganizationVisualisationApi Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrganizationVisualisationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \fr\helloasso\v5\model\OrganizationOrganizationModel
     */
    public function getOrganization($organization_slug, $authorization = null)
    {
        list($response) = $this->getOrganizationWithHttpInfo($organization_slug, $authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\OrganizationOrganizationModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationWithHttpInfo($organization_slug, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\OrganizationOrganizationModel';
        $request = $this->getOrganizationRequest($organization_slug, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\OrganizationOrganizationModel',
     ...
     */
    public function getOrganizationAsync($organization_slug, $authorization = null)
    {
        return $this->getOrganizationAsyncWithHttpInfo($organization_slug, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationAsyncWithHttpInfo($organization_slug, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\OrganizationOrganizationModel';
        $request = $this->getOrganizationRequest($organization_slug, $authorization);
     ...
     */
    protected function getOrganizationRequest($organization_slug, $authorization = null)
    {
        ...
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling getOrganization'
            );
        }
