...
class UsersApi
{
     ...
     * @return \fr\helloasso\v5\model\OrganizationOrganizationLightModel[]
     */
    public function getOrganizations($authorization = null)
    {
        list($response) = $this->getOrganizationsWithHttpInfo($authorization);
        return $response;
    }
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\OrganizationOrganizationLightModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationsWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\OrganizationOrganizationLightModel[]';
        $request = $this->getOrganizationsRequest($authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\OrganizationOrganizationLightModel[]',
     ...
     */
    public function getOrganizationsAsync($authorization = null)
    {
        return $this->getOrganizationsAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationsAsyncWithHttpInfo($authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\OrganizationOrganizationLightModel[]';
        $request = $this->getOrganizationsRequest($authorization);
     ...
     */
    protected function getOrganizationsRequest($authorization = null)
    {
