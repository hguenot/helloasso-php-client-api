...
/**
 * CheckoutIntentsManagementApi Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CheckoutIntentsManagementApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \fr\helloasso\v5\model\CartsCheckoutIntentResponse
     */
    public function getCheckoutIntent($organization_slug, $checkout_intent_id, $authorization = null)
    {
        list($response) = $this->getCheckoutIntentWithHttpInfo($organization_slug, $checkout_intent_id, $authorization);
        return $response;
    }

    /**
     * Operation getCheckoutIntentWithHttpInfo
     *
     * Retrieve a checkout intent, with the order if the payment has been authorized.
     *
     ...
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CartsCheckoutIntentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCheckoutIntentWithHttpInfo($organization_slug, $checkout_intent_id, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CartsCheckoutIntentResponse';
        $request = $this->getCheckoutIntentRequest($organization_slug, $checkout_intent_id, $authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CartsCheckoutIntentResponse',
    ...
    /**
     * Operation getCheckoutIntentAsync
     *
     * Retrieve a checkout intent, with the order if the payment has been authorized.
     *
     * @param  string $organization_slug (required)
     ...
     */
    public function getCheckoutIntentAsync($organization_slug, $checkout_intent_id, $authorization = null)
    {
        return $this->getCheckoutIntentAsyncWithHttpInfo($organization_slug, $checkout_intent_id, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCheckoutIntentAsyncWithHttpInfo
     *
     * Retrieve a checkout intent, with the order if the payment has been authorized.
     *
     * @param  string $organization_slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckoutIntentAsyncWithHttpInfo($organization_slug, $checkout_intent_id, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CartsCheckoutIntentResponse';
        $request = $this->getCheckoutIntentRequest($organization_slug, $checkout_intent_id, $authorization);
    ...
    /**
     * Create request for operation 'getCheckoutIntent'
     *
     * @param  string $organization_slug (required)
     * @param  int $checkout_intent_id (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     */
    protected function getCheckoutIntentRequest($organization_slug, $checkout_intent_id, $authorization = null)
    {
        ...
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling getCheckoutIntent'
            );
        }
        ...
        if ($checkout_intent_id === null || (is_array($checkout_intent_id) && count($checkout_intent_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkout_intent_id when calling getCheckoutIntent'
            );
        }
    ...
    /**
     * Operation postInitCheckout
     *
     * Init a checkout.
     *
     * @param  string $organization_slug organization_slug (required)
     * @param  \fr\helloasso\v5\model\CartsInitCheckoutBody $body body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \fr\helloasso\v5\model\CartsInitCheckoutResponse
     */
    public function postInitCheckout($organization_slug, $body, $authorization = null)
    {
        list($response) = $this->postInitCheckoutWithHttpInfo($organization_slug, $body, $authorization);
        return $response;
    }

    /**
     * Operation postInitCheckoutWithHttpInfo
     *
     * Init a checkout.
     *
     * @param  string $organization_slug (required)
     * @param  \fr\helloasso\v5\model\CartsInitCheckoutBody $body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     *
     * @throws \fr\helloasso\v5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \fr\helloasso\v5\model\CartsInitCheckoutResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postInitCheckoutWithHttpInfo($organization_slug, $body, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CartsInitCheckoutResponse';
        $request = $this->postInitCheckoutRequest($organization_slug, $body, $authorization);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\fr\helloasso\v5\model\CartsInitCheckoutResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postInitCheckoutAsync
     *
     * Init a checkout.
     *
     * @param  string $organization_slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postInitCheckoutAsync($organization_slug, $body, $authorization = null)
    {
        return $this->postInitCheckoutAsyncWithHttpInfo($organization_slug, $body, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postInitCheckoutAsyncWithHttpInfo
     *
     * Init a checkout.
     *
     * @param  string $organization_slug (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postInitCheckoutAsyncWithHttpInfo($organization_slug, $body, $authorization = null)
    {
        $returnType = '\fr\helloasso\v5\model\CartsInitCheckoutResponse';
        $request = $this->postInitCheckoutRequest($organization_slug, $body, $authorization);
    ...
    /**
     * Create request for operation 'postInitCheckout'
     *
     * @param  string $organization_slug (required)
     * @param  \fr\helloasso\v5\model\CartsInitCheckoutBody $body (required)
     * @param  string $authorization You can override the JWT used fo authorization here. ie : Bearer JWT_TOKEN (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postInitCheckoutRequest($organization_slug, $body, $authorization = null)
    {
        // verify the required parameter 'organization_slug' is set
        if ($organization_slug === null || (is_array($organization_slug) && count($organization_slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_slug when calling postInitCheckout'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postInitCheckout'
            );
        }
