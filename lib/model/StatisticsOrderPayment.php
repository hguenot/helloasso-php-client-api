...
/**
 * StatisticsOrderPayment Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatisticsOrderPayment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Statistics.OrderPayment';
    ...
    protected static $swaggerTypes = [
        'items' => '\fr\helloasso\v5\model\StatisticsShareItem[]',
     ...
     * Gets items
     *
     * @return \fr\helloasso\v5\model\StatisticsShareItem[]
     */
     ...
     * Sets items
     *
     * @param \fr\helloasso\v5\model\StatisticsShareItem[] $items items
     *
     * @return $this
     */
