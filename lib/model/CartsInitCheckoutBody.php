...
/**
 * CartsInitCheckoutBody Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CartsInitCheckoutBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Carts.InitCheckoutBody';
    ...
    protected static $swaggerTypes = [
        ...
        'terms' => '\fr\helloasso\v5\model\CartsCheckoutTerm[]',
        'payer' => '\fr\helloasso\v5\model\CartsCheckoutPayer',
        'metadata' => 'object'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['back_url'] = isset($data['back_url']) ? $data['back_url'] : null;
        ...
        $this->container['contains_donation'] = isset($data['contains_donation']) ? $data['contains_donation'] : null;
    ...
    public function setItemName($item_name)
    {
        if ((mb_strlen($item_name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $item_name when calling CartsInitCheckoutBody., must be smaller than or equal to 250.');
        }
     ...
     * Sets back_url
     *
     * @param string $back_url back_url
     *
     * @return $this
     */
     ...
     * Sets error_url
     *
     * @param string $error_url error_url
     *
     * @return $this
     */
     ...
     *
     * @param bool $contains_donation contains_donation
     *
     * @return $this
     */
     ...
     * Gets terms
     *
     * @return \fr\helloasso\v5\model\CartsCheckoutTerm[]
     */
     ...
     * Sets terms
     *
     * @param \fr\helloasso\v5\model\CartsCheckoutTerm[] $terms terms
     *
     * @return $this
     */
     ...
     * Gets payer
     *
     * @return \fr\helloasso\v5\model\CartsCheckoutPayer
     */
     ...
     * Sets payer
     *
     * @param \fr\helloasso\v5\model\CartsCheckoutPayer $payer payer
     *
     * @return $this
     */
