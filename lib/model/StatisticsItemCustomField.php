...
/**
 * StatisticsItemCustomField Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatisticsItemCustomField implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Statistics.ItemCustomField';
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'name' => 'string',
        'type' => '\fr\helloasso\v5\model\EnumsFieldType',
        'answer' => 'string'
    ];
     ...
     * Gets type
     *
     * @return \fr\helloasso\v5\model\EnumsFieldType
     */
     ...
     * Sets type
     *
     * @param \fr\helloasso\v5\model\EnumsFieldType $type type
     *
     * @return $this
     */
