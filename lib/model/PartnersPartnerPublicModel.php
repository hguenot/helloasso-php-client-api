...
/**
 * PartnersPartnerPublicModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnersPartnerPublicModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Partners.PartnerPublicModel';
    ...
    protected static $swaggerTypes = [
        ...
        'api_client' => '\fr\helloasso\v5\model\AccountsClientsApiClientModel',
        'url_notification_list' => '\fr\helloasso\v5\model\ApiNotificationsApiUrlNotificationModel[]',
        'partner_statistics' => '\fr\helloasso\v5\model\PartnerStatisticsModel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['api_client'] = isset($data['api_client']) ? $data['api_client'] : null;
        $this->container['url_notification_list'] = isset($data['url_notification_list']) ? $data['url_notification_list'] : null;
        $this->container['partner_statistics'] = isset($data['partner_statistics']) ? $data['partner_statistics'] : null;
    }
     ...
     * Gets api_client
     *
     * @return \fr\helloasso\v5\model\AccountsClientsApiClientModel
     */
     ...
     * Sets api_client
     *
     * @param \fr\helloasso\v5\model\AccountsClientsApiClientModel $api_client api_client
     *
     * @return $this
     */
     ...
     *
     * @return \fr\helloasso\v5\model\ApiNotificationsApiUrlNotificationModel[]
     */
     ...
     *
     * @param \fr\helloasso\v5\model\ApiNotificationsApiUrlNotificationModel[] $url_notification_list url_notification_list
     *
     * @return $this
     */
     ...
     *
     * @return \fr\helloasso\v5\model\PartnerStatisticsModel
     */
     ...
     *
     * @param \fr\helloasso\v5\model\PartnerStatisticsModel $partner_statistics partner_statistics
     *
     * @return $this
     */
