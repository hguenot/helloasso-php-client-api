...
/**
 * CartsCheckoutIntentResponse Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CartsCheckoutIntentResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Carts.CheckoutIntentResponse';
    ...
    protected static $swaggerTypes = [
        'metadata' => 'object',
        'order' => '\fr\helloasso\v5\model\StatisticsOrderDetail',
        'id' => 'int',
        'redirect_url' => 'string'
    ];
     ...
     * Sets order
     *
     * @param \fr\helloasso\v5\model\StatisticsOrderDetail $order order
     *
     * @return $this
     */
