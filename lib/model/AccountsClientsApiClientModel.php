...
/**
 * AccountsClientsApiClientModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountsClientsApiClientModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Accounts.Clients.ApiClientModel';
    ...
    protected static $swaggerTypes = [
        ...
        'privileges' => 'string[]',
        'domain' => 'string',
        'partner' => '\fr\helloasso\v5\model\PartnersPartnerPublicModel'
    ];
     ...
     * Sets partner
     *
     * @param \fr\helloasso\v5\model\PartnersPartnerPublicModel $partner partner
     *
     * @return $this
     */
