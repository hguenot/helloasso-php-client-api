<?php
/**
 * CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommonResultsWithPaginationModelOfDirectorySynchronizableFormModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Common.ResultsWithPaginationModelOfDirectory.SynchronizableFormModel';
    ...
    protected static $swaggerTypes = [
        'data' => '\fr\helloasso\v5\model\DirectorySynchronizableFormModel[]',
     ...
     * Gets data
     *
     * @return \fr\helloasso\v5\model\DirectorySynchronizableFormModel[]
     */
     ...
     * Sets data
     *
     * @param \fr\helloasso\v5\model\DirectorySynchronizableFormModel[] $data data
     *
     * @return $this
     */
