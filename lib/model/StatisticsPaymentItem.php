...
/**
 * StatisticsPaymentItem Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatisticsPaymentItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Statistics.PaymentItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['share_item_amount'] = isset($data['share_item_amount']) ? $data['share_item_amount'] : null;
        $this->container['share_options_amount'] = isset($data['share_options_amount']) ? $data['share_options_amount'] : null;
     ...
     *
     * @param int $share_item_amount share_item_amount
     *
     * @return $this
     */
     ...
     *
     * @param int $share_options_amount share_options_amount
     *
     * @return $this
     */
