<?php
/**
 * DirectorySynchronizableOrganizationModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DirectorySynchronizableOrganizationModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DirectorySynchronizableOrganizationModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Directory.SynchronizableOrganizationModel';
    ...
    protected static $swaggerTypes = [
        'action' => '\fr\helloasso\v5\model\EnumsRecordActionType',
        'record' => '\fr\helloasso\v5\model\OrganizationOrganizationBasicModel'
    ];
     ...
     * Gets action
     *
     * @return \fr\helloasso\v5\model\EnumsRecordActionType
     */
     ...
     * Sets action
     *
     * @param \fr\helloasso\v5\model\EnumsRecordActionType $action action
     *
     * @return $this
     */
     ...
     * Gets record
     *
     * @return \fr\helloasso\v5\model\OrganizationOrganizationBasicModel
     */
     ...
     * Sets record
     *
     * @param \fr\helloasso\v5\model\OrganizationOrganizationBasicModel $record record
     *
     * @return $this
     */
