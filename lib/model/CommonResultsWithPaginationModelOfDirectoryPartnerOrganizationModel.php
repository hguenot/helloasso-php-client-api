<?php
/**
 * CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommonResultsWithPaginationModelOfDirectoryPartnerOrganizationModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Common.ResultsWithPaginationModelOfDirectory.PartnerOrganizationModel';
    ...
    protected static $swaggerTypes = [
        'data' => '\fr\helloasso\v5\model\DirectoryPartnerOrganizationModel[]',
     ...
     * Gets data
     *
     * @return \fr\helloasso\v5\model\DirectoryPartnerOrganizationModel[]
     */
     ...
     * Sets data
     *
     * @param \fr\helloasso\v5\model\DirectoryPartnerOrganizationModel[] $data data
     *
     * @return $this
     */
