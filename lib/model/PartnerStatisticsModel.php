...
/**
 * PartnerStatisticsModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnerStatisticsModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerStatisticsModel';
    ...
    {
        $this->container['linked_organizations_count'] = isset($data['linked_organizations_count']) ? $data['linked_organizations_count'] : null;
        $this->container['linked_organizations_collected_amount'] = isset($data['linked_organizations_collected_amount']) ? $data['linked_organizations_collected_amount'] : null;
        $this->container['checkout_collected_amount'] = isset($data['checkout_collected_amount']) ? $data['checkout_collected_amount'] : null;
        $this->container['organizations_using_checkout'] = isset($data['organizations_using_checkout']) ? $data['organizations_using_checkout'] : null;
        $this->container['available_organizations_access_token_count'] = isset($data['available_organizations_access_token_count']) ? $data['available_organizations_access_token_count'] : null;
    }
     ...
     *
     * @param int $linked_organizations_count linked_organizations_count
     *
     * @return $this
     */
     ...
     *
     * @param int $linked_organizations_collected_amount linked_organizations_collected_amount
     *
     * @return $this
     */
     ...
     *
     * @param int $checkout_collected_amount checkout_collected_amount
     *
     * @return $this
     */
     ...
     *
     * @param int $organizations_using_checkout organizations_using_checkout
     *
     * @return $this
     */
     ...
     *
     * @param int $available_organizations_access_token_count available_organizations_access_token_count
     *
     * @return $this
     */
