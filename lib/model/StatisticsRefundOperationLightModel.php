...
/**
 * StatisticsRefundOperationLightModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatisticsRefundOperationLightModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Statistics.RefundOperationLightModel';
    ...
    protected static $swaggerTypes = [
        ...
        'amount' => 'int',
        'amount_tip' => 'int',
        'status' => '\fr\helloasso\v5\model\EnumsOperationState',
     ...
     * Gets status
     *
     * @return \fr\helloasso\v5\model\EnumsOperationState
     */
     ...
     * Sets status
     *
     * @param \fr\helloasso\v5\model\EnumsOperationState $status status
     *
     * @return $this
     */
