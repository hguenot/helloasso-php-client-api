...
/**
 * CommonPlaceModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommonPlaceModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Common.PlaceModel';
    ...
    protected static $swaggerTypes = [
        ...
        'zip_code' => 'string',
        'country' => 'string',
        'geo_location' => '\fr\helloasso\v5\model\HelloAssoModelsSharedGeoLocation'
    ];
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CommonPlaceModel., must be smaller than or equal to 3.');
        }
        if (!is_null($country) && (mb_strlen($country) < 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CommonPlaceModel., must be bigger than or equal to 3.');
        }
     ...
     * Sets geo_location
     *
     * @param \fr\helloasso\v5\model\HelloAssoModelsSharedGeoLocation $geo_location geo_location
     *
     * @return $this
     */
