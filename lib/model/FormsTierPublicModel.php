...
/**
 * FormsTierPublicModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FormsTierPublicModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Forms.TierPublicModel';
    ...
    protected static $swaggerTypes = [
        ...
        'label' => 'string',
        'description' => 'string',
        'tier_type' => '\fr\helloasso\v5\model\EnumsTierType',
        'price' => 'int',
        'vat_rate' => 'double',
        'min_amount' => 'int',
        'payment_frequency' => '\fr\helloasso\v5\model\EnumsPaymentFrequencyType',
        'max_per_user' => 'int',
        'meta' => '\fr\helloasso\v5\model\CommonMetaModel',
        'sale_start_date' => '\DateTime',
        'sale_end_date' => '\DateTime',
        'is_eligible_tax_receipt' => 'bool',
        'terms' => '\fr\helloasso\v5\model\FormsTermModel[]',
        'picture' => '\fr\helloasso\v5\model\CommonDocumentModel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['max_per_user'] = isset($data['max_per_user']) ? $data['max_per_user'] : null;
        ...
        $this->container['is_eligible_tax_receipt'] = isset($data['is_eligible_tax_receipt']) ? $data['is_eligible_tax_receipt'] : null;
     ...
     * Sets tier_type
     *
     * @param \fr\helloasso\v5\model\EnumsTierType $tier_type tier_type
     *
     * @return $this
     */
     ...
     *
     * @return \fr\helloasso\v5\model\EnumsPaymentFrequencyType
     */
     ...
     *
     * @param \fr\helloasso\v5\model\EnumsPaymentFrequencyType $payment_frequency payment_frequency
     *
     * @return $this
     */
     ...
     * Sets max_per_user
     *
     * @param int $max_per_user max_per_user
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_eligible_tax_receipt is_eligible_tax_receipt
     *
     * @return $this
     */
     ...
     * Gets terms
     *
     * @return \fr\helloasso\v5\model\FormsTermModel[]
     */
     ...
     * Sets terms
     *
     * @param \fr\helloasso\v5\model\FormsTermModel[] $terms terms
     *
     * @return $this
     */
     ...
     * Sets picture
     *
     * @param \fr\helloasso\v5\model\CommonDocumentModel $picture picture
     *
     * @return $this
     */
