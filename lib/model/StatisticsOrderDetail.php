...
/**
 * StatisticsOrderDetail Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatisticsOrderDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Statistics.OrderDetail';
    ...
    protected static $swaggerTypes = [
        ...
        'items' => '\fr\helloasso\v5\model\StatisticsOrderItem[]',
        'payments' => '\fr\helloasso\v5\model\StatisticsOrderPayment[]',
        'amount' => '\fr\helloasso\v5\model\StatisticsOrderAmountModel',
        'id' => 'int',
        'date' => '\DateTime',
        'form_slug' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['checkout_intent_id'] = isset($data['checkout_intent_id']) ? $data['checkout_intent_id'] : null;
     ...
     * Gets items
     *
     * @return \fr\helloasso\v5\model\StatisticsOrderItem[]
     */
     ...
     * Sets items
     *
     * @param \fr\helloasso\v5\model\StatisticsOrderItem[] $items items
     *
     * @return $this
     */
     ...
     * Gets payments
     *
     * @return \fr\helloasso\v5\model\StatisticsOrderPayment[]
     */
     ...
     * Sets payments
     *
     * @param \fr\helloasso\v5\model\StatisticsOrderPayment[] $payments payments
     *
     * @return $this
     */
     ...
     * Gets amount
     *
     * @return \fr\helloasso\v5\model\StatisticsOrderAmountModel
     */
     ...
     * Sets amount
     *
     * @param \fr\helloasso\v5\model\StatisticsOrderAmountModel $amount amount
     *
     * @return $this
     */
     ...
     *
     * @param int $checkout_intent_id checkout_intent_id
     *
     * @return $this
     */
