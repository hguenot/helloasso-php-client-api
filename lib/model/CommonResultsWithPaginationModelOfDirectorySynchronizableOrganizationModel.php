<?php
/**
 * CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel Class Doc Comment
 *
 * @category Class
 * @package  fr\helloasso\v5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommonResultsWithPaginationModelOfDirectorySynchronizableOrganizationModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Common.ResultsWithPaginationModelOfDirectory.SynchronizableOrganizationModel';
    ...
    protected static $swaggerTypes = [
        'data' => '\fr\helloasso\v5\model\DirectorySynchronizableOrganizationModel[]',
        'pagination' => '\fr\helloasso\v5\model\CommonPaginationModel'
    ];
     ...
     * Gets data
     *
     * @return \fr\helloasso\v5\model\DirectorySynchronizableOrganizationModel[]
     */
     ...
     * Sets data
     *
     * @param \fr\helloasso\v5\model\DirectorySynchronizableOrganizationModel[] $data data
     *
     * @return $this
     */
     ...
     * Gets pagination
     *
     * @return \fr\helloasso\v5\model\CommonPaginationModel
     */
     ...
     * Sets pagination
     *
     * @param \fr\helloasso\v5\model\CommonPaginationModel $pagination pagination
     *
     * @return $this
     */
